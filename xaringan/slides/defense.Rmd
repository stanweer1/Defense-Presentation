...
![:img 20%, 60%, 10%](../figs/short_barcode.png)
...
![:img 30%, 55%, 50%](../figs/brownian_loglog.png)
---
# All Systems
...
![:img 65%, 15%, 15%](../figs/chaos_sota.png)
...
![:img 50%, 22.5%, 17.5%](../figs/ML_Pipeline_detail.png)
...
---
# Multi-Channel EEG: ML Pipeline All Channels
...
---
# Multi-Channel: Co-Fluctuation Simpl. Complex Metrics
...
---
# Multi-Channel: Co-Fluctuation Simpl. Complex Results


| Metric                | AUC   | F1 Score | Accuracy |
|----------------------|-------|----------|----------|
| **complexity CT**    | **0.914** | **0.674**  | **0.771**  |
| total persistence    | 0.770 | 0.549    | 0.636    |
| hyper complexity     | 0.765 | 0.547    | 0.634    |
| complexity FD        | 0.737 | 0.527    | 0.619    |
| hyper coherence      | 0.592 | 0.447    | 0.553    |
| complexity FC        | 0.586 | 0.444    | 0.551    |
| betti L1             | 0.501 | 0.007    | 0.662    |
| betti L2             | 0.501 | 0.007    | 0.662    |
| avg edge violation   | 0.452 | 0.339    | 0.466    |
| persistence entropy  | 0.380 | 0.295    | 0.436    |
...
![:img 20%, 10%, 55%](../figs/vdp_tm_mat.png)
![:img 20%, 40%, 55%](../figs/vdp_hpm.png)
![:img 20%, 70%, 55%](../figs/vdp_hpd.png)

---
# Asymmetric Graph Homology
...
![:img 75%, 12.5%, 17.5%](../figs/homology_comparison.png)
...
<tr><td>Case I</td><td>✓</td><td class="highlight">×</td><td>✓</td><td>✓</td><td>✓</td><td>✓</td></tr>
<tr><td>Case II</td><td>✓</td><td class="highlight">×</td><td>✓</td><td>✓</td><td>0</td><td>0</td></tr>
<tr><td>Case III</td><td>✓</td><td class="highlight">✓</td><td>✓</td><td>✓</td><td>0</td><td>0</td></tr>
...
<tr><td>Case I</td><td class="highlight">0</td><td>×</td><td class="highlight">0</td><td>×</td><td>✓</td><td>×</td></tr>
<tr><td>Case II</td><td class="highlight">0</td><td>×</td><td class="highlight">0</td><td>×</td><td>✓</td><td>×</td></tr>
<tr><td>Case III</td><td class="highlight">0</td><td>×</td><td class="highlight">0</td><td>×</td><td>✓</td><td>×</td></tr>
...
<tr><td>Case I</td><td>✓</td><td>✓</td><td>✓</td><td>×</td><td>✓</td><td class="highlight">×</td></tr>
<tr><td>Case II</td><td>✓</td><td>✓</td><td>✓</td><td>×</td><td>✓</td><td class="highlight">×</td></tr>
<tr><td>Case III</td><td>✓</td><td>✓</td><td>✓</td><td>×</td><td>✓</td><td class="highlight">✓</td></tr>
...
![:img 45%, 20%, 20%](../figs/sota_boa.png)

---
# Future Work

![:img 65%, 20%, 30%](../figs/generators.png)

---
# Acknowledgements

![:img 75%, 10%, 20%](../figs/all_people.png)
...
.small-text[Published Papers]

.small-text[
1. (Internship) Bosca, V.^, Rask, T.^, **Tanweer, S.**^, Tawfeek, A.R.^, & Stone, B.. (2026). Topological Signatures of ReLU Neural Network Activation Patterns. Proceedings of the 1st Conference on Topology, Algebra, and Geometry in Data Science(TAG-DS 2025), in Proceedings of Machine Learning Research. 321:287-301. ^Equal contribution.
2. Khasawneh, F.A., Munch, E., **Tanweer, S.**, et al. (2025, March). *Teaspoon: A Python Package for Topological Signal Processing.* Journal of Open Source Software. https://doi.org/10.21105/joss.07243
3. **Tanweer, S.** & Khasawneh, F.A. (2024, May). *Topological detection of phenomenological bifurcations with unreliable kernel densities.* Probabilistic Engineering Mechanics. https://doi.org/10.1016/j.probengmech.2024.103634
4. **Tanweer, S.**, Khasawneh, F.A., & Munch, E. (2024, March). *Robust Zero-crossings Detection in Noisy Signals using Topological Signal Processing.* Foundations of Data Science. https://doi.org/10.3934/fods.2024006
5. **Tanweer, S.**, Khasawneh, F.A., Munch, E., et al. (2024, February). *A topological framework for identifying phenomenological bifurcations in stochastic dynamical systems.* Nonlinear Dynamics. https://doi.org/10.1007/s11071-024-09289-1
]

.small-text[Under Review]

.small-text[
1. **Tanweer, S.**, Khasawneh, F.A., & Subrahmaniyam, N.P. (2026, March). *Epileptic seizure prediction with topological machine learning.* (Under Review)
2. **Tanweer, S.** & Khasawneh, F.A. (2026, January). *Detecting Stochasticity in Discrete Signals via Nonparametric Excursion Theorem.* arXiv:2601.06009 (Under review at Chaos)
3. (AMS MRC) Timofeyev, T., Potvin, C., **Tanweer, S.**, et al. (2026, January). *Asymmetrically Weighted Dowker Persistence and Applications in Dynamical Systems.* arXiv:2601.04559 (Under review at JACT)
4. **Tanweer, S.** & Khasawneh, F.A. (2025, December). *P-Bifurcations in Stochastic Flutter Model Under Common Gust Perturbations.* arXiv:2512.14678 (Under Review)
5. **Tanweer, S.** & Khasawneh, F.A. (2025, December). *Unsupervised Learning of Kernel Density Estimates with Topology Optimization.* arXiv:2512.08895 (Under review at ICPR 2026)
6. **Tanweer, S.**, Khasawneh, F.A., & Mamis, K. (2025, April). *TDA for Detection of Phenomenological Bifurcations in Stochastic Epidemiological Models.* arXiv:2504.13215 (Under review at Mathematical Biosciences)
]
...
- Establish a new algorithms core

![:img 50%, 10%, 35%](../figs/whereto.png)

--

![:img 30%, 65%, 30%](../figs/theend.gif)
